...
@Autonomous(name="AutoRedBackTest with Limelight", group="Autonomous")
public class AutoRedBackML extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        telemetry.addLine("========================================");
        telemetry.addLine("RED ALLIANCE: GATE WEE WEE AUTO");
        ...
        if (!positionDetected) {
            robotX = RED_DEFAULT_START_X;
            robotY = RED_DEFAULT_START_Y;
    ...
    private void intakeSpikeBalls(double spike_x, double spike_y, double angle) {
        // spike_x and spike_y are in FEET (Red autonomous uses feet directly)
        ...
        driveToPosition(spike_x + 2.0, spike_y, angleRad); // Pass radians, not degrees
        intakeMotor.setPower(0);
        driveToPosition(spike_x, spike_y, 0);
    }
