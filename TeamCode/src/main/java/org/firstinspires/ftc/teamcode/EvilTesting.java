...
@TeleOp(name = "EvilTesting")
public class EvilTesting extends LinearOpMode {
    ...
    private static final double ARMOR_DEPLOY_POWER = 0.4;  // Continuous power while deployed
    private static final double ARMOR_RETRACT_POWER = -0.8;  // Strong retraction
    private static final int ARMOR_RETRACT_TIME_MS = 500;  // Time to fully retract
    ...
    // Using mecanum drive motor encoders for position tracking
    private static final double COUNTS_PER_MOTOR_REV = 537.7;  // REV HD Hex Motor (adjust for your motors)
    private static final double DRIVE_GEAR_REDUCTION = 1.0;
    private static final double WHEEL_DIAMETER_INCHES = 4.0;  // Adjust for your wheels
    ...
    // Drive encoder odometry tracking
    ...
    public void runOpMode() throws InterruptedException {
        ...
        // Armor motors (NEW - uses last 2 motor ports)
        ...
        // Configure encoders for drive motors (for odometry)
        ...
        telemetry.addLine("========================================");
        telemetry.addData("Motor Ports Used", "8 / 8 (ALL PORTS USED)");
        telemetry.addLine("========================================");
        ...
        boolean armorDeployed = false;  // NEW - armor state
        double launchMotorPower = 0.75;  // Start at 75%, adjustable 50-100%
        ...
        while (opModeIsActive()) {
            ...
            telemetry.addLine("--- Position (Drive Encoders) ---");
            ...
            telemetry.addData("🛡️ Armor", armorDeployed ? "DEPLOYED (LB to retract)" : "RETRACTED (LB to deploy)");
